      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="card-body">
              <?php 
                    $evalC = $row['supComment'];
                    //if()
                    echo $evalC ; ?>
            </div>
        </div>
          </div>
            <form method ="POST" action="addsupcomment.php">  
            <div class="form-group">
              <label for="comment">Add Comment</label>
              <textarea class="form-control" rows="3" id="supComment" placeholder="Add your comment....." name="comment" ></textarea>
            </div>
            <input type="hidden" id="wid" name="wid"<?php echo'value="'.$wid.'"'?>>
